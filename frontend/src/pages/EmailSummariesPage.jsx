    ...
    >
      <div className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-5 text-slate-700 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-lg font-semibold text-slate-900">All stored emails are eligible for summarization</p>
        </div>
        <button
          type="button"
      ...
      {result ? <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-slate-700">{result}</div> : null}
