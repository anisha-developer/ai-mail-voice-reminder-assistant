...
class VoiceReminderSession(Base):
    ...
    repeat_type: Mapped[str | None] = mapped_column(String(50), nullable=True)
    ...
    created_recurring_rule_id: Mapped[int | None] = mapped_column(ForeignKey("recurring_reminder_rules.id"), nullable=True, index=True)
    ...
    created_recurring_rule = relationship("RecurringReminderRule")
